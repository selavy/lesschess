...
#define CSL_NONE ((uint8_t)(0))
#define CSL_WQSIDE ((uint8_t)(1 << 0))
#define CSL_WKSIDE ((uint8_t)(1 << 1))
#define CSL_BQSIDE ((uint8_t)(1 << 2))
#define CSL_BKSIDE ((uint8_t)(1 << 3))
#define CSL_ALL (CSL_WQSIDE | CSL_WKSIDE | CSL_BQSIDE | CSL_BKSIDE)
#define CSL_WSIDE (CSL_WQSIDE | CSL_WKSIDE)
#define CSL_BSIDE (CSL_BQSIDE | CSL_BKSIDE)
#define CSL_SIDE(side) ((side) == WHITE ? CSL_WSIDE : CSL_BSIDE)
#define EP_NONE 64
